...
const AddSalesManager = () => {
    ...
    const handleCreateSalesManager = (e) => {
        e.preventDefault();

        setIsLoading(true);

        axios
            .post(`${Constants.BASE_URL}/sales-managers`, input)
            .then((res) => {
    ...
    return (
        <>
            <Breadcrumb title={"Create Sales Manager"} />
            <div className="container-fluid">
                <Card to={"/sales-manager"} title={"Create Sales Manager"} btnText={"Sales Manager List"}>
                    <form className="form-row" onSubmit={handleCreateSalesManager}>
                        ...
                        <SubmitButton value={"Create Sales Manager"} isLoading={isLoading} />
                    </form>
                </Card>
            </div>
        </>
