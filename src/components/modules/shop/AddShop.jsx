...
const AddShop = () => {
    ...
    return (
        <>
            <Breadcrumb title={"Create Shop"} />
            <div className="container-fluid">
                <Card to={"/shop"} title={"Create Shop"} btnText={"Shop List"}>
                    <form className="form-row" onSubmit={handleCreateShop}>
                        ...
                        <SubmitButton value={"Create Shop"} isLoading={isLoading} />
                    </form>
                </Card>
            </div>
        </>
