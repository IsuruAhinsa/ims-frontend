    ...
    return (
        <>
            ...
            <div className="container-fluid">
                <Card to={"/brand"} title={"Edit Brand"} btnText={"Brand List"}>
                    <form className="form-row" onSubmit={handleUpdateBrand}>
                        ...
                        <SubmitButton value={"Update Brand"} isLoading={isLoading} />
                    </form>
                </Card>
            </div>
        </>
